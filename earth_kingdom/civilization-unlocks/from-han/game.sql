...
VALUES ('REQ_CIV_IS_HAN_EARTH_KINGDOM', 'REQUIREMENTSET_TEST_ALL');

INSERT INTO UnlockRequirements 
       (RequirementSetId,               UnlockType,                          Description,                                        NarrativeText,                                         ToolTip) 
VALUES ('REQ_CIV_IS_HAN_EARTH_KINGDOM', 'UNLOCK_CIVILIZATION_EARTH_KINGDOM', 'LOC_UNLOCK_PLAY_AS_HAN_EARTH_KINGDOM_DESCRIPTION', 'LOC_UNLOCK_PLAY_AS_HAN_EARTH_KINGDOM_NARRATIVE_TEXT', 'LOC_UNLOCK_PLAY_AS_HAN_EARTH_KINGDOM_TOOLTIP');

INSERT INTO Requirements 
       (RequirementId,                  RequirementType) 
VALUES ('REQ_CIV_IS_HAN_EARTH_KINGDOM', 'REQUIREMENT_PLAYER_CIVILIZATION_TYPE_MATCHES');

INSERT INTO RequirementArguments 
       (RequirementId,                  Name,               Value) 
VALUES ('REQ_CIV_IS_HAN_EARTH_KINGDOM', 'CivilizationType', 'CIVILIZATION_HAN');

INSERT INTO RequirementSetRequirements 
       (RequirementId,                  RequirementSetId) 
VALUES ('REQ_CIV_IS_HAN_EARTH_KINGDOM', 'REQ_CIV_IS_HAN_EARTH_KINGDOM');
